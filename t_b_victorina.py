...
questions = {1: [("Когда было крещение Руси?", "988"),("Кто был первым президентом России?", "Борис Ельцин")],
            2: [("Кто был последним императором Российской империи?", "Николай II"),("Сколько лет просуществовал СССР?", "69")],
            3: [("Когда Российская Империя отказалась от крепостного права?", "1861"),("Какая страна была самая огромная по территория за всю историю мира?", "Британская Империя")]}
